...
Companion repository for Chapter 15, "Day 2 Operations and CI/CD for Agentic Systems," of the book *Building Safe Agentic AI for Enterprise Systems*. It demonstrates, as working code, how to run CI/CD on a non-deterministic agentic RAG system without weakening the deterministic validation gates the book builds in earlier chapters.
